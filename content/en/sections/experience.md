...
## Hansol PNS — IT · AI Development Team — Full-Stack (solo)
...
**Scope of ownership** — Built the FE directly (chat, Generative UI, back-office dashboard, and more) · Built the BE directly (metering, usage-limit control, preview, and PDF capture APIs) · Understood & integrated designs (Kafka pipeline · permission.go). See the [Coverage Map](#coverage) for the full layer-by-layer breakdown.
...
## PTKOREA (Samsung Cheil Worldwide subsidiary) — Full-Stack Internship
