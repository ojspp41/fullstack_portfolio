...
stack: [React, TypeScript, TanStack Query, Node.js, Clean Architecture, JSON / PDF Report]
metrics:
...
decision: Deterministic rules—not the LLM—make the final classification.
---

### From inspection requests to reports and history

- **Frontend** — React, TypeScript, and TanStack Query for inspection creation, progress, results, history, Risk Graph, and improvement recommendations.
- **Backend** — Node.js, TypeScript, and Clean Architecture connecting file/ZIP inputs, inspection of public GitHub/GitLab repositories, asynchronous inspection state, and JSON/PDF reports.
